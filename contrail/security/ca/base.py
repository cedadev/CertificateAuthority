...
class AbstractCertificateAuthority(object):
    ...
    def parse_config(self, cfg, prefix='', section='DEFAULT'):
        ...
        self.parse_keyfiles(cert_filepath, prikey_filepath,
    ...
    def from_keywords(cls, prefix='', **kw):
        ...
        if cert_filepath and prikey_filepath:
            obj.parse_keyfiles(cert_filepath, prikey_filepath,
                               key_file_passwd=prikey_file_passwd)
    ...
    def parse_keyfiles(self, cert_filepath, key_filepath, key_file_passwd=None):
        ...
        self.cert = crypto.load_certificate(crypto.FILETYPE_PEM, cert_file_txt)

    @classmethod
    def from_keyfiles(cls, cert_filepath, key_filepath, key_file_passwd=None):
        """Construct new instance certificate and private key files
        @return: new certificate authority instance
        """
        ca = cls()
        ca.parse_keyfiles(cert_filepath, key_filepath,
